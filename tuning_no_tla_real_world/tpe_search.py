...
def run_tpe_search():
    ...
    #space = {
    #    'rls_method': hp.choice('rls_method', ['QR-LSQR','SVD-LSQR','SVD-PGD']),
    ...
    #trials = generate_trials_to_calculate([{'rls_method':'QR-LSQR', 'sketch_operator':'sjlt', 'sampling_factor':5.0, 'vec_nnz':50 }])
    if npilot == 0:
                ...
                if sample["rls_method"] == "QR-LSQR":
                    if sample["sketch_operator"] == "sjlt":
                        ...
                        P_ = { "rls_method": 1,
                               ...
                               "vec_nnz": sample["vec_nnz"],
                               "safety_exponent": sample["safety_exponent"] }
                elif sample["rls_method"] == "SVD-LSQR":
                    if sample["sketch_operator"] == "sjlt":
                        P_ = { "rls_method": 2,
                               "sketch_operator": 1,
                               "sampling_factor": sample["sampling_factor"],
                        ...
                        P_ = { "rls_method": 2,
                               ...
                               "vec_nnz": sample["vec_nnz"],
                               "safety_exponent": sample["safety_exponent"] }
                elif sample["rls_method"] == "SVD-PGD":
                    if sample["sketch_operator"] == "sjlt":
                        P_ = { "rls_method": 3,
                               "sketch_operator": 1,
                               "sampling_factor": sample["sampling_factor"],
